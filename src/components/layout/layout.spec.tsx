          ...
          edges: [
            {
              node: {
                frontmatter: {
                  ...
                  url: 'job1-project1-url',
                  tags: ['job1-project1-tags'],
                },
              ...
              next: {
                frontmatter: {
                  ...
                  url: 'job1-project2-url',
                  tags: ['job1-project2-tags'],
                },
          ...
          edges: [
            {
              node: {
                frontmatter: {
                  ...
                  url: 'job2-project1-url',
                  tags: ['job2-project1-tags'],
                },
              ...
              next: {
                frontmatter: {
                  ...
                  url: 'job2-project2-url',
                  tags: ['job2-project2-tags'],
                },
