...
const Cart: FC = () => {
  ...
  return (
    <div>
      <Text heading="Cart">
        <p>
          A key part of GraphQL is the transferral of work from the client to
          the server. Not only does the user have to have a consistent network
          connection, requests have to be made to change local data. Building a
          shopping cart means that every quantity update requires a network
          round trip.
        </p>
        <p>
          ...
          the server can be predicted, that information can be used to update
          the UI. When the actual response arrives, the prediction is replaced
          with the real data.
        </p>
      </Text>
      ...
      <Text>
        <p ref={visibleRef}>
          ...
          previous has succeeded, the network request is resolved in the
